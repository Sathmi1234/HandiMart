  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <Text style={styles.headerTitle}>Ongoing Bids</Text>
        <IconButton
          icon="magnify"
          size={24}
      ...
      <View style={styles.content}>
        ...
        <View style={styles.sectionHeader}>
          ...
          <TouchableOpacity onPress={() => router.push("/(tabs)/bids/yourBids")}>
        ...
        <View style={styles.sectionHeader}>
          ...
          <TouchableOpacity onPress={() => router.push("/(tabs)/bids/trendingBids")}>
            <Text style={styles.seeAllText}>See All</Text>
          </TouchableOpacity>
        </View>
